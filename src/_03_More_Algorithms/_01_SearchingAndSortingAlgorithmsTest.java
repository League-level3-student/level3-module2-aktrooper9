...
public class _01_SearchingAndSortingAlgorithmsTest {
    ...
    public void testSort() throws Exception {
        ...
        assertEquals(38.4,(double) Algorithms.sortScores(results).get(0), 0.0);
        assertEquals(40.7,(double) Algorithms.sortScores(results).get(1), 0.0);
        assertEquals(95.0,(double) Algorithms.sortScores(results).get(13), 0.0);
    }
